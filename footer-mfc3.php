...
?>    
    <style>
        ...
        @media (max-width: 520px) {
            .popup-item__cnt .calculation__variants .calculation__radio, .popup-item__cnt .calculation__variants .calculation__checkbox {
    ...
    <div class="fixed-modal--rbk-info-popup hidden">
        <div class="content-cnt">
            <div class="content">
                <p>На основании предоставленного АО "РОСБИЗНЕСКОНСАЛТИНГ" (АО "РБК") исследования в октябре 2023 г, был сделан вывод о том, что компания «Финансово-правовой альянс» является лидером по среднесписочной численности сотрудников среди компаний, специализирующихся на банкротстве граждан в России.</p>
            </div>
            <div class="close">
    ...
    <div class="popup__cnt hidden">
        <div class="popup__overlay">
            ...
            <div class="popup-item__cnt mfc__cnt mfc-new__number-1 hidden" data-form-name="SMS-12 Пройдите тест и узнайте, вправе ли вы обанкротиться бесплатно или с субсидией в Арбитражном суде или МФЦ до <?php echo $popup_year_date->format('j') . ' ' . $popup_year_arr[$popup_year_month]; ?>" data-form-sms="17" data-form-time="1" data-form-title="Узнайте, вправе ли вы обанкротиться бесплатно или с субсидией в Арбитражном суде или МФЦ до <?php echo $popup_year_date->format('j') . ' ' . $popup_year_arr[$popup_year_month]; ?> <?php echo date ( 'Y' ) ; ?> г.!">
                ...
                <?php echo do_shortcode( "[quiz_for_articles id='4367' title='Узнайте, вправе ли вы <span class=\"text-accent\">обанкротиться бесплатно</span> через МФЦ или с <span class=\"text-accent\">бесплатным юридическим сопровождением</span> в Арбитражном суде <span class=\"text-accent\"> " . $popup_year_date->format('j') . "&nbsp;" . $popup_year_arr[$popup_year_month] . "&nbsp;" . date ( 'Y' ) ." г.,</span> ответив на 11 вопросов!']" ); ?>
            </div>
            <div class="popup-item__cnt mfc__cnt mfc-new__number-2 hidden" data-form-name="SMS-13 Пройдите тест и узнайте минимальную стоимость банкротства в Арбитражном суде или МФЦ до <?php echo $popup_year_date->format('j') . ' ' . $popup_year_arr[$popup_year_month]; ?>" data-form-sms="18" data-form-time="1" data-form-title="Узнайте минимальную стоимость банкротства в Арбитражном суде или МФЦ до <?php echo $popup_year_date->format('j') . ' ' . $popup_year_arr[$popup_year_month]; ?> <?php echo date ( 'Y' ) ; ?> г.!">
                ...
                <?php echo do_shortcode( "[quiz_for_articles id='4366' title='Узнайте <span class=\"text-red\">минимальную стоимость юридического сопровождения Вашей процедуры банкротства</span> в Арбитражном суде или МФЦ <span class=\"text-red\">" . $popup_year_date->format('j') . "&nbsp;" . $popup_year_arr[$popup_year_month] . "&nbsp;" . date ( 'Y' ) ." г.,</span> ответив на 10 вопросов!']" ); ?>
            </div>

            ...
            <div class="reviews-v2__wrap hidden_">
                <div class="reviews-v2__row">
                    <div class="reviews-v2__col">
                        ...
                        ?>
                        <div class="hidden"><?php print_r($tag_arr); ?></div>
                            ...
                            <div class="filter-block__cnt first-filter-block__cnt">
                                ...
                                <div class="field-range__cnt">
                                    ...
                                    <div class="range-lines__cnt">
                                        <input type="range" name="range_summ" value="0" class="field_range_summ" id="answer_range_summ" min="0" max="4" step="1">
                        ...
                        <div class="reviews-selection-grid">
                            <?php
                                ...
                                if ($pagination_paged > 1) {
                                    $pagination_offset = 21 * $pagination_paged;
                                    if (!empty($tag_arr)) {
                                        $args_video_reviews = ([
                                            'posts_per_page' => '21',
                                        ...
                                        <div class="review-video__cnt">
                                            <div class="reviews-item">
                                                <?php if (has_post_thumbnail($photo_reviews_arr->posts[$i]->ID) ): ?>
                                                    ...
                                                    <a href="<?=get_permalink($video_reviews_arr->posts[$i]->ID); ?>">
                                                        <img src="<?=$image[0]; ?>" alt="<?=$photo_reviews_arr->posts[$i]->post_title; ?>">
                                                    </a>
                                                    <div class="case-number">Дело: <?=get_field('case', $photo_reviews_arr->posts[0]->ID); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php
                            ...
                            <div class="reviews-row reviews-type-video selection-grid-3">
                                <div class="review-first <?php if (count($video_reviews_arr->posts) < 11) { echo "hidden"; } ?>">
                                    <?php if (count($video_reviews_arr->posts) > 10) { ?>
                                    <div class="review-first__cnt">
                                        <div class="head">
                                            <div class="title"><?=$video_reviews_arr->posts[11]->post_title; ?></div>
                                            <div class="number">№ <?=$video_reviews_arr->posts[11]->ID; ?></div>
                                        </div>
                                        <div class="body">
                                            <div class="reviews-item">
                                                <div class="youtube" data-embed="<?=get_field('id_video', $video_reviews_arr->posts[11]->ID); ?>" onclick="ym(82134583,'reachGoal','start')">
                                                    <div class="youtube__button">
                                                        <svg><use xlink:href="https://fpa.ru/wp-content/themes/fpalaw/assets/img/sprite.svg#play"></use></svg>
                                                    </div>
                                                    <img src="https://img.youtube.com/vi/<?=get_field('id_video', $video_reviews_arr->posts[11]->ID); ?>/maxresdefault.jpg" alt="Превью для видео">
                                                </div>
                                            </div>
                                            <div class="additional-items">
                                                <div class="additional-resources-row">
                                                    <a class="original-link" href="<?=get_field('link_court_ruling', $video_reviews_arr->posts[11]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_opredelenie_suda.svg" alt="" />
                                                        <span>Оригинал<br> определения суда</span>
                                                    </a>
                                                    <a class="original-link" href="<?=get_field('link_cards', $video_reviews_arr->posts[11]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_kartoteka.svg" alt="" />
                                                        <span>Картотека<br> арбитражного суда</span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="foot">
                                            <div class="item-features">
                                                <div class="item-features-row">
                                                    <div class="title">Номер дела в суде:</div>
                                                    <div class="value"><?=get_field('case', $video_reviews_arr->posts[11]->ID); ?></div>
                                                </div>
                                            </div>
                                            <div class="link">
                                                <a href="<?=get_permalink($video_reviews_arr->posts[11]->ID); ?>">Посмотреть всю информацию</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="review-video-additional__cnt <?php if (count($video_reviews_arr->posts) < 12) { echo "hidden"; } ?>">
                                    <?php if (count($video_reviews_arr->posts) > 11) { ?>
                                    <?php
                                        for ($i = 12; $i <= 17; $i++) {
                                    ?>
                                        <div class="review-video__cnt">
                            ...
                            <div class="reviews-row reviews-type-photo selection-grid-4">
                                <div class="review-first <?php if (count($photo_reviews_arr->posts) < 11) { echo "hidden"; } ?>">
                                    <?php if (count($photo_reviews_arr->posts) > 10) { ?>
                                    <div class="review-first__cnt">
                                        <div class="head">
                                            <div class="title"><?=$photo_reviews_arr->posts[11]->post_title; ?></div>
                                            <div class="number">№ <?=$photo_reviews_arr->posts[11]->ID; ?></div>
                                        </div>
                                        <div class="body">
                                            <div class="reviews-item">
                                                <?php if (has_post_thumbnail($photo_reviews_arr->posts[11]->ID) ): ?>
                                                    <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id($photo_reviews_arr->posts[11]->ID), 'single-post-thumbnail' ); ?>
                                                    <img src="<?=$image[0]; ?>" alt="<?=$photo_reviews_arr->posts[11]->post_title; ?>">
                                                    <div class="case-number__cnt">
                                                        <span>Дело: <span><?=get_field('case', $photo_reviews_arr->posts[0]->ID); ?></span></span>
                                                        <span>Списан долг: <span><?=get_field('amount_of_debt', $photo_reviews_arr->posts[0]->ID); ?> ₽</span></span>
                                                    </div>
                                            ...
                                            <div class="additional-items">
                                                <div class="additional-resources-row">
                                                    <a class="original-link" href="<?=get_field('link_court_ruling', $photo_reviews_arr->posts[11]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_opredelenie_suda.svg" alt="" />
                                                        <span>Оригинал<br> определения суда</span>
                                                    </a>
                                                    <a class="original-link" href="<?=get_field('link_cards', $photo_reviews_arr->posts[11]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_kartoteka.svg" alt="" />
                                                        <span>Картотека<br> арбитражного суда</span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="foot">
                                            <div class="item-features">
                                                <div class="item-features-row">
                                                    <div class="title">Номер дела в суде:</div>
                                                    <div class="value"><?=get_field('case', $photo_reviews_arr->posts[11]->ID); ?></div>
                                                </div>
                                            </div>
                                            <div class="link">
                                                <a href="<?=get_permalink($photo_reviews_arr->posts[11]->ID); ?>">Посмотреть всю информацию</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="review-video-additional__cnt <?php if (count($photo_reviews_arr->posts) < 12) { echo "hidden"; } ?>">
                                    <?php if (count($photo_reviews_arr->posts) > 11) { ?>
                                    <?php
                                        for ($i = 12; $i <= 17; $i++) {
                                    ?>
                                        <div class="review-video__cnt">
                            ...
                            <div class="reviews-row reviews-type-video selection-grid-5 <?php if (count($video_reviews_arr->posts) < 18) { echo "hidden"; } ?>">
                                <div class="review-first">
                                    <?php if (count($video_reviews_arr->posts) > 17) { ?>
                                    <div class="review-first__cnt">
                                        <div class="head">
                                            <div class="title"><?=$video_reviews_arr->posts[18]->post_title; ?></div>
                                            <div class="number">№ <?=$video_reviews_arr->posts[18]->ID; ?></div>
                                        </div>
                                        <div class="body">
                                            <div class="reviews-item">
                                                <div class="youtube" data-embed="<?=get_field('id_video', $video_reviews_arr->posts[18]->ID); ?>" onclick="ym(82134583,'reachGoal','start')">
                                                    <div class="youtube__button">
                                                        <svg><use xlink:href="https://fpa.ru/wp-content/themes/fpalaw/assets/img/sprite.svg#play"></use></svg>
                                                    </div>
                                                    <img src="https://img.youtube.com/vi/<?=get_field('id_video', $video_reviews_arr->posts[18]->ID); ?>/maxresdefault.jpg" alt="Превью для видео">
                                                </div>
                                            </div>
                                            <div class="additional-items">
                                                <div class="additional-resources-row">
                                                    <a class="original-link" href="<?=get_field('link_court_ruling', $video_reviews_arr->posts[18]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_opredelenie_suda.svg" alt="" />
                                                        <span>Оригинал<br> определения суда</span>
                                                    </a>
                                                    <a class="original-link" href="<?=get_field('link_cards', $video_reviews_arr->posts[18]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_kartoteka.svg" alt="" />
                                                        <span>Картотека<br> арбитражного суда</span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="foot">
                                            <div class="item-features">
                                                <div class="item-features-row">
                                                    <div class="title">Номер дела в суде:</div>
                                                    <div class="value"><?=get_field('case', $video_reviews_arr->posts[18]->ID); ?></div>
                                                </div>
                                            </div>
                                            <div class="link">
                                                <a href="<?=get_permalink($video_reviews_arr->posts[18]->ID); ?>">Посмотреть всю информацию</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="review-video-additional__cnt <?php if (count($video_reviews_arr->posts) < 19) { echo "hidden"; } ?>">
                                    <?php if (count($video_reviews_arr->posts) > 18) { ?>
                                    <?php
                                        for ($i = 19; $i <= 21; $i++) {
                                    ?>
                                        <div class="review-video__cnt">
                            ...
                            <div class="reviews-row reviews-type-photo selection-grid-6">
                                <div class="review-first <?php if (count($photo_reviews_arr->posts) < 18) { echo "hidden"; } ?>">
                                    <?php if (count($photo_reviews_arr->posts) > 17) { ?>
                                    <div class="review-first__cnt">
                                        <div class="head">
                                            <div class="title"><?=$photo_reviews_arr->posts[18]->post_title; ?></div>
                                            <div class="number">№ <?=$photo_reviews_arr->posts[18]->ID; ?></div>
                                        </div>
                                        <div class="body">
                                            <div class="reviews-item">
                                                <?php if (has_post_thumbnail($photo_reviews_arr->posts[18]->ID) ): ?>
                                                    <?php $image = wp_get_attachment_image_src( get_post_thumbnail_id($photo_reviews_arr->posts[18]->ID), 'single-post-thumbnail' ); ?>
                                                    <img src="<?=$image[0]; ?>" alt="<?=$photo_reviews_arr->posts[18]->post_title; ?>">
                                                    <div class="case-number__cnt">
                                                        <span>Дело: <span><?=get_field('case', $photo_reviews_arr->posts[0]->ID); ?></span></span>
                                                        <span>Списан долг: <span><?=get_field('amount_of_debt', $photo_reviews_arr->posts[0]->ID); ?> ₽</span></span>
                                                    </div>
                                            ...
                                            <div class="additional-items">
                                                <div class="additional-resources-row">
                                                    <a class="original-link" href="<?=get_field('link_court_ruling', $photo_reviews_arr->posts[18]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_opredelenie_suda.svg" alt="" />
                                                        <span>Оригинал<br> определения суда</span>
                                                    </a>
                                                    <a class="original-link" href="<?=get_field('link_cards', $photo_reviews_arr->posts[18]->ID); ?>" title="Вы переходите на сайт Арбитражного суда города Санкт‑Петербурга и Ленинградской области">
                                                        <img src="/wp-content/themes/fpalaw/assets/img/reviews/document_kartoteka.svg" alt="" />
                                                        <span>Картотека<br> арбитражного суда</span>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="foot">
                                            <div class="item-features">
                                                <div class="item-features-row">
                                                    <div class="title">Номер дела в суде:</div>
                                                    <div class="value"><?=get_field('case', $photo_reviews_arr->posts[18]->ID); ?></div>
                                                </div>
                                            </div>
                                            <div class="link">
                                                <a href="<?=get_permalink($photo_reviews_arr->posts[18]->ID); ?>">Посмотреть всю информацию</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="review-video-additional__cnt <?php if (count($photo_reviews_arr->posts) < 19) { echo "hidden"; } ?>">
                                    <?php if (count($photo_reviews_arr->posts) > 18) { ?>
                                    <?php
                                        for ($i = 19; $i <= 21; $i++) {
                                    ?>
                                        <div class="review-video__cnt">

...
<div class="inner">
  <div class="container">
    ...
    <div class="inner__head">
      <h1 class="title-page"><span class="case-total-1">12&nbsp;057</span> <span class="case-works">дел</span> находятся в работе на текущий момент</h1>
    </div>
                  ...
                  <div class="results__block results__block--inner">
                    <div class="results__data results__data--in-dela">
                      <ul class="results__lst results__lst--in-dela">
                        ...
                        <li class="results__lst-item">
                          <span class="results__number results-number case-successful results-number-2" data-start="0" data-number="2210">4603</span>

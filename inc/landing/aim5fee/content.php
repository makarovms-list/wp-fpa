...
section#aim4free .property-list {
    display: flex;
...
section#aim4free .property-list .property-item {
    z-index: 999;
}
section#aim4free .property-list .property-item.item1 {
    width: 130px;
}
section#aim4free .property-list .property-item.item2 {
    width: 200px;
}
section#aim4free .property-list .property-item.item3 {
    width: 120px;
}
section#aim4free .property-list .property-item.item4 {
    width: 140px;
}
section#aim4free .property-list .property-item .title {
    font-family: Montserrat;
    font-size: 1.75em;
    font-weight: 700;
    line-height: 120%;
...
section#aim4free .property-list .property-item .subtitle {
    font-family: Inter;
    font-size: .9em;
    font-weight: 400;
    line-height: 120%;
...
@media (max-width: 782px) {
    ...
    section#aim4free .property-list:before {
        content: "";
        position: absolute;
        top: 0;
        left: -22px;
            ...
            <div class="content-row">
                <div class="content-col">
                    ...
                    <div class="property-list">
                        <div class="property-item item1">
                            <div class="title">300</div>
                            <div class="subtitle">Юристов в штате</div>
                        </div>
                        <div class="property-item item2">
                            <div class="title">15 000</div>
                            <div class="subtitle">Успешно завершенных дел</div>
                        </div>
                        <div class="property-item item3">
                            <div class="title">100 %</div>
                            <div class="subtitle">Выигранных дел</div>
                        </div>
                        <div class="property-item item4">
                            <div class="title">> 1000</div>
                            <div class="subtitle">Реальных отзывов</div>
                        </div>
                    </div>

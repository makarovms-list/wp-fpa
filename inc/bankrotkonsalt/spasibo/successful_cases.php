...
?>
        <style>
            ...
            section.successful_cases .inner {
                            ...
                            <div class="inner__block">
                                ...
                                <div class="inner__row inner__row--mobile">
                                    <?php foreach($successful_cases['triggers_for_section_display'] as $key => $value) { ?>
                                        ...
                                        ?>
                                        <div class="cases__cnt <?=$value['question']; ?> <?=$additional_classes; ?>" data-question="<?=$value['question']; ?>" data-answer="<?=$value['answer']['answer_option_'.$value['question']][0]['value']; ?>">

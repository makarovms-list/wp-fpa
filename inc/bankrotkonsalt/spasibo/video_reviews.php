        ...
        <section class="reviews-art ip">
            <div class="container">
                <?php foreach($video_reviews['triggers_for_section_display'] as $key => $value) { ?>
                    ...
                    ?>
                    <div class="title__cnt <?=$value['question']; ?> <?=$additional_classes; ?>" data-answer="<?=$value['answer']['answer_option_'.$value['question']][0]['value']; ?>" data-question="<?=$value['question']; ?>">
                ...
                <?php foreach($video_reviews['triggers_for_section_display'] as $key => $value) { ?>
                    ...
                    ?>
                    <div class="reviews-art__wrap <?=$value['question']; ?> <?=$additional_classes; ?>" data-question="<?=$value['question']; ?>" data-answer="<?=$value['answer']['answer_option_'.$value['question']][0]['value']; ?>">

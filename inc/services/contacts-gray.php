<section id="services_contacts" class="section contacts contacts--services section--services-grey">
  <div class="container">
    ...
    <div class="contacts__wrap">
      <div class="contacts__block contacts__block--content">
        ...
        <div class="contacts__inner contacts__inner--double">
          ...
          <a class="link link--contact contacts__link" href="tel:<? echo do_shortcode('[sc name="phone-link-1"]'); ?>"><? echo do_shortcode('[sc name="phone-1"]'); ?></a>
        </div>
        -->
        <div class="contacts__inner contacts__inner--double">

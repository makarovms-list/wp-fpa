<section id="services_hurry-no-heading" class="section--services-grey hurry">
  <div class="container">
    <div class="section__image section__image--hurry lazy"></div>
    <p class="title-page">Нужно ли спешить с банкротством?</p>
      ...
      <div class="hurry__inner">
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Ранее мы рекомендовали не спешить с банкротством
              <br> до формирования судебной практики</p>
            <p class="hurry__text">Теперь время играет против вас</p>
          </div>
        </div>
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Ждать больше нечего</p>
        ...
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Кредиторы становятся агрессивнее</p>
        ...
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Сроки процедур банкротства увеличиваются</p>
        ...
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Появляются прецеденты с отказом в списании долгов</p>
        ...
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Некоторые граждане обязаны начать банкротство</p>
        ...
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Стоимость процедур банкротства будет расти</p>
            <p class="hurry__text">Всё это неизбежно отразится на стоимости квалифицированной правовой помощи</p>
          </div>
        </div>
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Точно такие же тенденции мы наблюдали после возникновения в России процедуры банкротства физических лиц — индивидуальных предпринимателей</p>
            <p class="hurry__text">В итоге банкротство стало сложнее и дороже, а в некоторых случаях — невозможным</p>
          </div>
        </div>
        <div class="hurry__tab">
          <div class="hurry__content">
            <p class="hurry__title">Начните работу над долгом прямо сейчас!</p>

...
<section class="mfc">
  <div class="container">
    <div class="mfc__wrap">
      ...
      <h1 class="mfc__title"><span class="text-accent">Потеряли до 500 000 ₽ на Финико</span> и не можете платить кредиты? Узнайте вправе ли вы бесплатно списать долги в МФЦ <span class="text-accent text-nowrap">до <?php echo $date->format('j') . ' ' . $arr[$month]; ?> <?php echo date ( 'Y' ) ; ?> г. </span>!</h1>
      <div class="mfc__block-btn">
        <!--<button class="btn mfc__btn mfc-btn-free" id="mfc-btn-free-finiko" data-finiko="free" data-name="SMS-12 (Финико) Пройдите тест и узнайте, вправе ли вы обанкротиться бесплатно или с субсидией в Арбитражном суде или МФЦ до <?php echo $date->format('j') . ' ' . $arr[$month]; ?>" data-sms="22" data-title="06">Пройти тест</button>-->
        <button class="btn mfc__btn hidden-btn" id="mfc-btn-free-finiko" data-sms="22" data-popup-id="mfc-fineko__number-1" data-color-schema="blue" data-title="06">Пройти тест</button>

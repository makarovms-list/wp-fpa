...
<section class="mfc mfc--sale">
  <div class="container">
    <div class="mfc__wrap">
      ...
      <h2 class="mfc__title"><span class="text-pink">Потеряли больше 500 000 ₽ на Финико</span> и не можете платить кредиты? Узнайте вправе ли вы списать кредиты через банкротство в Арбитражном суде <span class="text-pink">до <?php echo $date->format('j') . ' ' . $arr[$month]; ?> <?php echo date ( 'Y' ) ; ?> г.</span>!</h2>
      <div class="mfc__block-btn">
        <!--<button class="btn mfc__btn mfc__btn--pink mfc-btn-sale" id="mfc-btn-sale-finiko" data-finiko="sale" data-name="SMS-13 (Финико) Пройдите тест и узнайте минимальную стоимость банкротства в Арбитражном суде или МФЦ до <?php echo $date->format('j') . ' ' . $arr[$month]; ?>" data-sms="23" data-title="07">Пройти тест</button>-->
        <button class="btn mfc__btn mfc__btn--pink hidden-btn" id="mfc-btn-free-finiko" data-sms="23" data-popup-id="mfc-fineko__number-2" data-color-schema="pink" data-title="07">Пройти тест</button>

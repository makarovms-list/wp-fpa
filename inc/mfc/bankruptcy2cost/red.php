    ...
    <div class="bankruptcy2cost_container">
        <div class="bankruptcy2cost__wrap">
            ...
            <div class="bankruptcy2cost__block-btn">
                ...
                <button class="btn bankruptcy2cost__btn hidden-btn" data-sms="20" data-popup-id="mfc-bankruptcy__number-2" onclick="ym(82134583, 'reachGoal', '1button'); return true;">Пройти тест</button>

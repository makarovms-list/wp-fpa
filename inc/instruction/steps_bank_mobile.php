<style>
    ...
    .step-item .step_item-cnt blockquote {
        margin-left: 20px;
        margin-right: 0;
    }
    ...
    .step-item blockquote {
        margin-top: -12px;
        margin-bottom: -12px;
    }
    .step-item blockquote p {
        font-size: 1em;
        margin-bottom: 0;
        font-family: Inter;
        line-height: 145%;
                        ...
                        <div class="step_item-cnt">
                            ...
                            ?>
                                            <div class="template_cnt">
                                                ...
                                                <div class="txt"><?=$value['additional_app_link']; ?></div>
                                            </div>
                            <?
                                        }
                            ?>

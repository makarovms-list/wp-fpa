<div class="form-aside">
  <h3 class="form-aside__title">Спишем ваши долги за 2 000 ₽ в месяц</h3>
  
  <?php echo do_shortcode( '[contact-form-7 id="1088" title="Верхняя секция на странице Услуги - Пройти банкротство за 2000 р./мес" html_class="form-aside__form"]' ); ?>

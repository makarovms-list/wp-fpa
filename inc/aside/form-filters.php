<form class="form-filter">
  <div class="form-filter__block form-filter__block--mobile">
    ...
    <div class="form-filter__row form-filter__row--range">
      <ul class="range-list range-list--current">
        <li class="range-list__item range-list__item--current show">Все суммы</li>
        <li class="range-list__item range-list__item--current">до 300 т.р.</li>
        <li class="range-list__item range-list__item--current">300 - 500 т.р.</li>
        <li class="range-list__item range-list__item--current">500 т.р. - 1 млн.р.</li>
        <li class="range-list__item range-list__item--current">1 - 3 млн.р.</li>
        <li class="range-list__item range-list__item--current">от 3 млн.р.</li>
      </ul>
    ...
    <button class="no-btn btn-show">
      ...
      <span class="btn-show__arrow"> </span>
    </button>
  </div>
  ...
  <button id="archive-dela_form-filter__btn-sort" class="btn form-filter__btn-sort">
